package com.synectiks.search.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
	...
	public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity,
		...
		ProblemBuilder builder = Problem.builder()
				...
				.with(PATH_KEY, request.getNativeRequest(HttpServletRequest.class)
						.getRequestURI());

		if (problem instanceof ConstraintViolationProblem) {
			builder.with(VIOLATIONS_KEY,
