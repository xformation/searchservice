...
import com.synectiks.search.security.SecurityUtils;
...
public class AccountResource {
	...
	private static class AccountResourceException extends RuntimeException {
		private static final long serialVersionUID = 6964630061726468927L;
	}
	 ...
	 * @throws AccountResourceException {@code 500 (Internal Server Error)} if
	 *             the user couldn't be returned.
	 */
	@GetMapping("/account")
