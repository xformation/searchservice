package com.synectiks.search.config;
...
import com.synectiks.search.security.jwt.JWTConfigurer;
import com.synectiks.search.security.jwt.TokenProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
				...
				.antMatchers("/api/**").authenticated().antMatchers("/management/health")
				.permitAll().antMatchers("/management/info").permitAll()
